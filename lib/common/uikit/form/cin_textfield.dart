...
import 'package:revolution1401/common/utils/form_validators.dart';
...
class _CinTextFieldState extends State<CinTextField>
            ...
            FormBuilderTextField(
              ...
              decoration: widget.decoration ??
                  InputDecoration(
                    ...
                    fillColor: widget.fillColor ?? context.colors.background,
                    hoverColor: Colors.transparent,
                    isDense: true,
                    contentPadding: widget.contentPadding ??
                        const EdgeInsets.symmetric(
                            horizontal: 14, vertical: 16),
                    focusedBorder: widget.focusNode == null
                    ...
                    errorStyle: Theme.of(context).textTheme.caption!.copyWith(
                        ...
                        color: context.colors.error.dark),
              ...
              cursorColor: widget.cursorColor ?? context.colors.cursor,
  ...
  OutlineInputBorder _errorBorder(BuildContext context) => OutlineInputBorder(
  ...
  OutlineInputBorder _defaultBorder(BuildContext context) => OutlineInputBorder(
        borderRadius: widget.borderRadius ?? BorderRadius.circular(6),
