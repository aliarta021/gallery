...
import 'package:revolution1401/common/uikit/date_picker_modal.dart';
...
import 'package:revolution1401/common/utils/modal_helper.dart';
            ...
            return CinTextField(
              ...
              style: widget.style ??
                  Theme.of(context)
                      .textTheme
                      .subtitle2!
                      .copyWith(fontFamily: context.localeNumericFont, color: context.colors.textCaption),
