...
class CinPageFooter extends StatelessWidget {
  const CinPageFooter(
      {required this.onSubmit, Key? key, this.onCancel, this.submitText, this.cancelText, this.invert = false})
      : super(key: key);
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Row(
          textDirection: invert ? context.invertLocaleDirection : context.localeDirection,
          children: [
            Expanded(
              flex: 3,
              child: CinButton(
