...
class CinListView<T> extends StatelessWidget {
  ...
  factory CinListView.manual({
    ...
    Widget Function(BuildContext context, Widget? prefixWidget)?
        emptyListBuilder,
  ...
  final Widget Function(BuildContext context, Widget? prefixWidget)?
      emptyListBuilder;
  ...
  Widget build(BuildContext context) => items.isEmpty && !loading
      ? ListView(
          ...
          padding: padding,
          children: [
            if ((showPrefixOnEmpty ?? (emptyListBuilder == null)) &&
                prefixWidget != null)
              prefixWidget!,
      ...
      : ListView.separated(
          ...
          padding: padding,
          itemCount:
              (loading ? 5 : items.length) + (prefixWidget != null ? 1 : 0),
          itemBuilder: (context, index) {
            ...
            return loading
                ...
                : itemBuilder(
                    context, items[index - (prefixWidget != null ? 1 : 0)]);
          },
          separatorBuilder: (context, _) =>
              (separatorBuilder ?? _defaultSeparatorBuilder).call(context),
        );
}
